...
/******/ 	__webpack_require__.p = "/seat-planner/";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var main = new _mainController2.default(pkg);
	main.init();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _previewImage = __webpack_require__(33);

	var _previewImage2 = _interopRequireDefault(_previewImage);

	var _previewSvg = __webpack_require__(34);

	var _previewSvg2 = _interopRequireDefault(_previewSvg);

	var _jquery = __webpack_require__(35);

	var _jquery2 = _interopRequireDefault(_jquery);

	var _dropzone = __webpack_require__(36);
	...
	var MainController = function () {
	  ...
	  _createClass(MainController, [{
	    ...
	    key: 'hookFileInput',
	    value: function hookFileInput() {
	      (0, _jquery2.default)('.file-input a').on('click', function click(e) {
	        e.preventDefault();
	        (0, _jquery2.default)(this).find('+ .file-input__input').trigger('click');
	      });
	    }
	  }, {
	    key: 'hookFileInputFilesSelected',
	    value: function hookFileInputFilesSelected() {
	      var self = this;
	      (0, _jquery2.default)('.file-input a + .file-input__input').on('change', function click(e) {
	        e.preventDefault();
	        var file = void 0;
	        ...
	        try {
	          for (var _iterator = (0, _jquery2.default)(this).prop('files')[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            file = _step.value;

	            if (file.type.match(/image/)) {
	              var reader = new FileReader();
	              reader.onloadend = function (fileEvent) {
	                var content = fileEvent.target.result;
	    ...
	    value: function initPreview() {
	      (0, _jquery2.default)('#preview-images').append((0, _previewSvg2.default)({
	        id: 'no-images',
	        content: __webpack_require__(37)
	      }));
	    }
	  }, {
	    key: 'plopPreviewImageBase64',
	    value: function plopPreviewImageBase64(content) {
	      (0, _jquery2.default)('#preview-images').append((0, _previewImage2.default)({ content: content }));
	    }
	  }, {
	    key: 'initDropzone',
	    value: function initDropzone() {
	      ...
	      var dropzone = new _dropzone2.default('#dropzone');
	      dropzone.on('windowenter', function () {
	        (0, _jquery2.default)('#dropzone').addClass('is-active');
	      });
	      dropzone.on('dropzoneenter', function () {
	        (0, _jquery2.default)('#dropzone').addClass('is-active');
	      });
	      dropzone.on('dropzoneexit', function () {
	        (0, _jquery2.default)('#dropzone').removeClass('is-active');
	      });
	      dropzone.on('dropzonedropped', function () {
	        (0, _jquery2.default)('#dropzone').removeClass('is-active');
	      });
	      dropzone.on('illegaltype', function (e, file) {
	        console.log(file);
	      });
	      dropzone.on('filedone', function (e, fileEvent, content) {
	        (0, _jquery2.default)('#dropzone').removeClass('is-active');
	        _this.plopPreviewImageBase64(content);
	      });
	    }
	  }, {
	    key: 'plopDefaultTemplate',
	    value: function plopDefaultTemplate() {
	      (0, _jquery2.default)('main').append((0, _main2.default)({
	        package: this._pkg,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pug = __webpack_require__(31);

	function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (logo) {pug_html = pug_html + "\u003Csection class=\"hero is-primary\"\u003E\u003C!-- Hero header: will stick at the top--\u003E\u003Cdiv class=\"hero-head\"\u003E\u003Cheader class=\"nav\"\u003E\u003Cdiv class=\"container\"\u003E\u003Cdiv class=\"nav-left\"\u003E\u003Cspan class=\"nav-item\"\u003E\u003Ca class=\"button is-primary\" href=\"\u002F\"\u003E\u003Cimg" + (pug.attr("src", logo, true, true)+" alt=\"Sitzplaner Logo\"") + "\u003E\u003C\u002Fa\u003E\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"nav-center\"\u003E\u003Ca class=\"nav-item\" href=\"https:\u002F\u002Fgithub.com\u002FPrioe\"\u003E\u003Cspan class=\"icon\"\u003E\u003Ci class=\"fa fa-github\"\u003E\u003C\u002Fi\u003E\u003C\u002Fspan\u003E\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"nav-right nav-menu\"\u003E\u003Cspan class=\"nav-item\"\u003E\u003Cdiv class=\"file-input\"\u003E\u003Ca class=\"button is-primary\" href=\"#\"\u003E\u003Cspan class=\"icon\"\u003E\u003Ci class=\"fa fa-plus-circle\"\u003E\u003C\u002Fi\u003E\u003C\u002Fspan\u003E\u003Cspan\u003EBilder hinzufügen\u003C\u002Fspan\u003E\u003C\u002Fa\u003E\u003Cinput class=\"file-input__input\" type=\"file\" multiple\u003E\u003C\u002Fdiv\u003E\u003C\u002Fspan\u003E\u003Cspan class=\"nav-item\"\u003E\u003Ca class=\"button is-primary is-disabled\" href=\"#\"\u003E\u003Cspan class=\"icon\"\u003E\u003Ci class=\"fa fa-download\"\u003E\u003C\u002Fi\u003E\u003C\u002Fspan\u003E\u003Cspan\u003EDownload\u003C\u002Fspan\u003E\u003C\u002Fa\u003E\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fheader\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"hero-body\"\u003E\u003Cdiv class=\"container\"\u003E\u003Cdiv class=\"preview box\"\u003E\u003Cdiv class=\"preview-container\" id=\"preview-images\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fsection\u003E\u003Cdiv class=\"dropzone modal\" id=\"dropzone\"\u003E\u003Cdiv class=\"modal-background\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"modal-container\"\u003E\u003Cdiv class=\"modal-content\"\u003E\u003Cdiv class=\"container has-text-centered\"\u003E\u003Ch1 class=\"subtitle is-1\"\u003EBilder hinzufügen\u003C\u002Fh1\u003E\u003Ci class=\"fa fa-copy fa-5x\"\u003E\u003C\u002Fi\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";}.call(this,"logo" in locals_for_with?locals_for_with.logo:typeof logo!=="undefined"?logo:undefined));;return pug_html;};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (content, id) {pug_html = pug_html + "\u003Cfigure" + (" class=\"image is-96x96\""+pug.attr("id", id, true, true)) + "\u003E\u003Cimg" + (" draggable=\"false\""+pug.attr("src", content, true, true)) + "\u003E\u003C\u002Ffigure\u003E";}.call(this,"content" in locals_for_with?locals_for_with.content:typeof content!=="undefined"?content:undefined,"id" in locals_for_with?locals_for_with.id:typeof id!=="undefined"?id:undefined));;return pug_html;};
	module.exports = template;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (content, fallback, id) {pug_html = pug_html + "\u003Cfigure" + (" class=\"image is-96x96\""+pug.attr("id", id, true, true)) + "\u003E\u003Cobject" + (pug.attr("data", content, true, true)+" type=\"image\u002Fsvg+xml\"") + "\u003E\u003Cimg" + (pug.attr("src", fallback, true, true)) + "\u003E\u003C\u002Fobject\u003E\u003C\u002Ffigure\u003E";}.call(this,"content" in locals_for_with?locals_for_with.content:typeof content!=="undefined"?content:undefined,"fallback" in locals_for_with?locals_for_with.fallback:typeof fallback!=="undefined"?fallback:undefined,"id" in locals_for_with?locals_for_with.id:typeof id!=="undefined"?id:undefined));;return pug_html;};
	module.exports = template;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dropzone = function (_$$fn$init) {
	  _inherits(Dropzone, _$$fn$init);

	  function Dropzone(selector) {
	    _classCallCheck(this, Dropzone);

	    var _this = _possibleConstructorReturn(this, (Dropzone.__proto__ || Object.getPrototypeOf(Dropzone)).call(this, selector));
	  ...
	  _createClass(Dropzone, [{
	    key: 'emitOnValidDrag',
	    value: function emitOnValidDrag(e, triggerEvent) {
	      var target = (0, _jquery2.default)(e.target);
	      var source = (0, _jquery2.default)(e.originalEvent.srcElement);
	    ...
	    value: function addEventListeners() {
	      var self = this;
	      (0, _jquery2.default)(window).on('dragenter', function dragenter(e) {
	        e.preventDefault();
	        e.stopPropagation();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "0da89146abda24795e393deb9abb8536.svg";

/***/ },
/* 38 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "d19274601a57c430ec9f9d07ad24b3c8.png";
...
/***/ function(module, exports) {
	...
	module.exports = {
		"name": "seat-planner",
		"version": "1.1.0",
		"description": "gh-pages to create nice seating charts.",
		...
		"repository": {
			"type": "git",
			"url": "https://github.com/Prioe/seat-planner.git"
		},
		"devDependencies": {
			"babel-eslint": "^6.1.2",
			"babel-loader": "^6.2.5",
